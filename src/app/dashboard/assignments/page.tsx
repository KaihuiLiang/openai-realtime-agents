              ...
              {assignments.map((a) => (
                <tr key={a.id} className="hover:bg-emerald-50/50 transition-colors">
                  ...
                  <td className="p-4 text-slate-700 font-medium">
                    {(a as Assignment & { display_name?: string }).display_name || a.agent_name}
                    {a.agent_name && (a as Assignment & { display_name?: string }).display_name && (
                  ...
                  <td className="p-4">
                    <div className="flex items-center justify-end gap-2">
                      <Link href={`/dashboard/assignments/${a.id}/edit`} className="px-3 py-1.5 rounded-lg text-xs font-medium bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors">Edit</Link>
                      <RowActions id={a.id} />
                    </div>
                  </td>
                </tr>
