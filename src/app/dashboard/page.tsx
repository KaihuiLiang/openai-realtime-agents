...
export default async function ExperimenterHome() {
  ...
  <Card label="Agents" value={counts.agents} href="/dashboard/agents" color="blue" />
        <Card label="Participants" value={counts.participants} href="/dashboard/participants" color="purple" />
        <Card label="Assignments" value={counts.assignments} href="/dashboard/assignments" color="emerald" />
      </div>
    </div>
  );
}
