                ...
                <tr key={p.id} className="hover:bg-purple-50/50 transition-colors">
                  ...
                  <td className="p-4">
                    <div className="flex items-center justify-end gap-2">
                      <Link href={`/dashboard/participants/${p.id}/edit`} className="px-3 py-1.5 rounded-lg text-xs font-medium bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors">Edit</Link>
                      <RowActions id={p.id} />
                    </div>
                  </td>
                </tr>
